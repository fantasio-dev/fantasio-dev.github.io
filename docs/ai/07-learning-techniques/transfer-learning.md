...
{: .highlight }
> **Transfer Learning**: 기존의 학습된 모델과 비슷한 유형의 다른 모델로 학습된 결과를 옮겨서 부족한 데이터를 통한 학습이나 훈련 시간을 단축시키는 머신 러닝 기법
> - (키워드) 미세조정(Fine Tuning), 과업/도메인 전이, Inductive/Transductive/Unsupervised
