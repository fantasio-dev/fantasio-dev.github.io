---
layout: default
title: AI (인공지능) - Legacy
parent: AI (인공지능)
nav_exclude: true
has_toc: false
permalink: /docs/ai/legacy
---

# AI (인공지능) - Legacy <span class="page-title-with-cta__ctas"><a class="exam-top-cta" href="{{ site.baseurl }}/docs/ai/daily">🃏 데일리 암기 덱</a><a class="exam-top-cta" href="{{ site.baseurl }}/docs/ai/map">🧭 레거시 MAP</a><a class="exam-top-cta" href="{{ site.baseurl }}/docs/ai/exam">📝 기출문제</a></span>
{: .fs-9 .page-title-with-cta }

이 페이지는 **롤백용 레거시 백업**입니다. 최신 통합 페이지는 `{{ site.baseurl }}/docs/ai` 를 참고하세요.
{: .note }
